...
const businessOwnerNotificationTemplates = {
  ...
  businessOwnerPaymentReminder: {
    ...
    message: 'Your business monthly subscription payment is due soon. Please ensure your payment method is up to date to avoid any interruption to your admin access.',
    type: 'warning',
  ...
  businessOwnerPaymentOverdue: {
    ...
    message: 'Your business subscription payment is overdue. Your admin access has been temporarily suspended.',
    type: 'payment',
  ...
  businessOwnerNewFeature: {
    ...
    message: 'We\'ve added new features to your business admin panel to help you manage your business better.',
    type: 'update',
  ...
  businessOwnerMaintenance: {
    ...
    message: 'We will be performing scheduled maintenance to improve business panel performance.',
    type: 'info',
  ...
  businessOwnerOrderAlert: {
    ...
    message: 'You have received a new order for your business that requires your attention.',
    type: 'success',
...
const sendBusinessOwnerNotificationToUser = async (emailOrUsername, notificationData) => {
  try {
    ...
    if (businessOwner.role !== 'admin' && !businessOwner.isAdmin) {
      console.log('❌ User is not a business owner. Only business owners can receive business owner notifications.');
      return;
    }
